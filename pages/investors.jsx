  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #f8fafc 0%, #e0e7ef 100%)', fontFamily: 'Inter, Arial, sans-serif' }}>
      ...
      <main style={{ maxWidth: 800, margin: '0 auto', padding: '3rem 1rem 2rem 1rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 800, color: '#22223b', marginBottom: '2rem', letterSpacing: '-0.03em' }}>For Investors</h1>
        <p style={{ color: '#22223b', marginBottom: '1.2rem', lineHeight: 1.7, fontSize: '1.15rem' }}>
          CauseMap is not just a visualization of history. It is a foundation for a new form of analysis:
        </p>
        <ul style={{ color: '#444', marginBottom: '1.2rem', lineHeight: 1.7, paddingLeft: '1.2em' }}>
          <li>Education, research, forecasting</li>
          <li>Subscriptions, analytics, B2B API</li>
          <li>Potential for creating an AI-powered semantic analytics engine</li>
        </ul>
        <p style={{ color: '#666', fontStyle: 'italic', marginTop: '2rem' }}>
          We are open to partnerships and discussions. This project is built with love and attention to detail. Our goal is to make understanding the world accessible.
        </p>
      </main>
